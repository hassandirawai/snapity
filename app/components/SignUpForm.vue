...
<template>
  <Card :class="cn('overflow-hidden p-0', props.class)">
    <CardContent class="grid p-0 md:grid-cols-2">
      <form
        class="flex flex-col gap-6 relative p-6 md:p-8"
        @submit="onSubmit"
      >
        ...
        <div class="relative text-sm text-center after:absolute after:border-t after:border-border after:top-1/2 after:w-full after:z-0 after:flex">
